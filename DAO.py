...
# Camada mais inferior da model, a DAO é o Data Acess Object
# (Objeto de acesso ao dados)
...
class DaoFornecedor:
    ...
    def ler(cls):
        ...
        for i in cls.fornecedores:
            forn.append(Fornecedor(Produtos(i[0], i[1], i[2], i[3])))
    ...
    def salvar(cls, pessoas: Pessoa):
        with open('dados/clientes.txt', 'a') as arq:
            arq.writelines(pessoas.nome + "|" + pessoas.telefone +
                         "|" + pessoas.cpf + "|" + pessoas.email + "|" + pessoas.endereco)
            arq.writelines('\n')
